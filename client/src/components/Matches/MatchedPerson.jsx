...
const  MatchedPerson = () => {
  return (
    <div className="w-2xl ">
      <p className="mb-2">
        {" "}
        For 90 matches based on your <Link to='/partner-preferences' className="text-orange-400 underline" href="">Preferences</Link>{" "}
      </p>
      <div className="flex flex-wrap gap-2">
        ...
        <div className="p-1 border-1  border-gray-300  text-sm rounded-4xl ">Location</div>
